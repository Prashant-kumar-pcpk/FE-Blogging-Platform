    ...
    <footer className="bg-gray-900 text-white py-12 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              />
              <h3 className="text-2xl font-bold"><i>Prashant Dairies</i></h3>
            </div>
            <p className="text-gray-400 mb-4">
              A modern blogging platform for writers and readers to connect and share ideas.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/authors" className="text-gray-400 hover:text-white transition-colors">Authors</Link></li>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-full text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
              />
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2026 Prashant Dairies. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
